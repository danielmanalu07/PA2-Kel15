<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#requestTable" aria-expanded="true"
            aria-controls="Product">
            <i class="fas fa-fw fa-book"></i>
            <span>Request Table</span>
        </a>
        <div id="requestTable" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Custom Request Table</h6>
                <a class="collapse-item" href={{route('admin.requestTable.index')}}>List Table</a>
            </div>
        </div>
    </li>
